...
// 데이터베잇의 종류
// 관계형 데이터베이스
// 1. MySQL : 무료 DBMS이었다가 오라클로 인수합병되면서 일부 무료 => MariaDB
...
// 2. 레디스 - 키-값 형식으로 자료를 저장하는 DB, Memory-DB 속도 빨라 캐시용 DB로 사용
// 3. Neo4j - 자료를 노드와 관계형식으로 저장하는 DB
...
// mongodb+srv://admin:1234@cluster0.opynx.mongodb.net/
